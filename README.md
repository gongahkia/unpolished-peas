...
`script/package_linux.sh` writes a statically linked x86_64 Linux bounce tarball and checksum manifest; `script/test_linux_package.sh` verifies the archive, static linkage, asset layout, and bounded smoke outside the repository.
