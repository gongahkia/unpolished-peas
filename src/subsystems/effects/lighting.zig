...
pub fn lighting(comptime core: type) type {
    const Camera2D = core.Camera2D;
    const CameraCanvas = core.CameraCanvas;
    const Canvas = core.Canvas;
    const ClipRect = core.ClipRect;
    const Color = core.Color;
    const Vec2 = core.Vec2;
    const Rect = core.Rect;
    const CommandBuffer = core.RenderCommandBuffer;
