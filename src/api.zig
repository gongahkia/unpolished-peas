...
pub const NetContract = @import("net_contract.zig").Config;
pub const NetConnection = @import("net_contract.zig").Connection;
pub const NetContractError = @import("net_contract.zig").Error;
pub const NetIdentity = @import("net_contract.zig").Identity;
pub const NetMode = @import("net_contract.zig").Mode;
pub const NetRole = @import("net_contract.zig").Role;
pub const NetReliability = @import("net_contract.zig").Reliability;
pub const NetSession = @import("net_contract.zig").Session;
pub const netContract = @import("net_contract.zig");
...
pub const P2pConfig = @import("net_p2p.zig").Config;
pub const P2pState = @import("net_p2p.zig").State;
pub const P2pFailure = @import("net_p2p.zig").Failure;
pub const P2pRoute = @import("net_p2p.zig").Route;
pub const netP2p = @import("net_p2p.zig");
pub const NatCandidate = @import("net_nat.zig").Candidate;
pub const NatCandidateKind = @import("net_nat.zig").CandidateKind;
pub const NatGatherer = @import("net_nat.zig").Gatherer;
pub const NatTraversalClient = @import("net_nat.zig").Client;
pub const NatTraversalRoute = @import("net_p2p.zig").Route;
pub const netNat = @import("net_nat.zig");
pub const P2pMigration = @import("net_migration.zig").Coordinator;
pub const P2pMigrationConfig = @import("net_migration.zig").Config;
pub const P2pMigrationState = @import("net_migration.zig").GameState;
pub const P2pMigrationDecision = @import("net_migration.zig").Decision;
pub const netMigration = @import("net_migration.zig");
...
pub const ReplicationSchema = @import("net_ecs_replication.zig").Schema;
pub const ReplicationStateAdapter = @import("net_ecs_replication.zig").StateAdapter;
pub const SceneReplicationSchema = @import("net_ecs_replication.zig").SceneSchema;
pub const SceneReplicationAdapter = @import("net_ecs_replication.zig").SceneAdapter;
...
pub const NetHostRole = @import("net_session.zig").HostRole;
...
pub const PredictionConfig = @import("net_sync.zig").PredictionConfig;
pub const PredictionClient = @import("net_sync.zig").PredictionClient;
pub const AuthoritativeState = @import("net_sync.zig").AuthoritativeState;
pub const AuthoritativeServer = @import("net_sync.zig").Server;
