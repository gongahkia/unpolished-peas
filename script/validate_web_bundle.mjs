...
assert.ok(root);
for (const path of ["index.html", "bootstrap.mjs", "host.mjs", "input.mjs", "audio.mjs", "storage.mjs", "artifacts.mjs", "renderer_diagnostics.mjs", "unpolished-peas.wasm", "web-manifest.json", "SHA256SUMS"]) await access(`${root}/${path}`, constants.R_OK);
