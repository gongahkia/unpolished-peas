...
printf '%s\n' '<!doctype html><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>unpolished-peas</title><canvas data-unpolished-peas width="320" height="180" tabindex="0"></canvas><script type="module" src="./bootstrap.mjs"></script>' > "$package/index.html"
