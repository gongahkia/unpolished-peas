...
printf '%s\n' 'format=unpolished-peas-package' 'version=1' 'platform=linux-x86_64' 'runtime=bin/unpolished-peas-bounce' 'assets=assets/' 'docs=docs/' 'launcher=launcher.json' 'bundled-runtime=SDL3:static' > "$package/PACKAGE-MANIFEST.txt"
